...
import { Mail, Lock, ArrowRight, BarChart2, AlertCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="flex min-h-screen flex-col md:flex-row bg-slate-50 font-sans">
      ...
      <div className="hidden md:flex w-full md:w-1/2 flex-col justify-center bg-gradient-to-br from-indigo-600 to-indigo-500 p-12 lg:p-24 text-white">
        <div className="mb-12 flex items-center gap-3">
          ...
          <span className="text-2xl font-bold tracking-tight">SellerMetrics</span>
        </div>
      ...
      <div className="flex w-full md:w-1/2 flex-col items-center justify-center p-6 sm:p-12">
        ...
        <div className="mb-12 flex w-full max-w-md items-center gap-3 md:hidden">
          ...
          <span className="text-2xl font-bold tracking-tight text-slate-900">SellerMetrics</span>
        </div>

        <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white/80 p-8 sm:p-10 shadow-xl backdrop-blur-xl">
          <h2 className="mb-6 text-2xl font-bold text-slate-900">Login to your account</h2>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="mt-2 flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block cursor-pointer text-sm text-slate-600">
                  Remember Me
                </label>
              </div>
              <div className="text-sm">
                <a href="#" className="font-semibold text-indigo-600 transition-colors hover:text-indigo-800">
                  Forgot Password?
                </a>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-transparent bg-indigo-600 px-4 py-3.5 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
          ...
          <div className="mt-8 text-center text-sm">
            ...
            <Link to="/register" className="font-semibold text-indigo-600 transition-colors hover:text-indigo-800">
              Create Account
            </Link>
          </div>
        </div>
