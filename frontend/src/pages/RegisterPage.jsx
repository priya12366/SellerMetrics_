...
import { Mail, Lock, ArrowRight, BarChart2, User, Building2, AlertCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    const { fullName, businessName, email, password, confirmPassword, terms } = formData;
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const backendError = data.detail ? (typeof data.detail === 'string' ? data.detail : data.detail[0]?.msg) : null;
    ...
    <div className="flex min-h-screen flex-col md:flex-row bg-slate-50 font-sans">
      ...
      <div className="flex w-full md:w-1/2 flex-col items-center justify-center overflow-y-auto p-6 sm:p-12">
        ...
        <div className="my-8 w-full max-w-md rounded-3xl border border-slate-200 bg-white/80 p-8 sm:p-10 shadow-xl backdrop-blur-xl md:my-0">
          <h2 className="mb-6 text-2xl font-bold text-slate-900">Get started for free</h2>
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <div className="mt-4 flex items-start pt-2">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="cursor-pointer text-slate-600">
                  I agree to the <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-800">Terms</a> & <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-800">Privacy Policy</a>
                </label>
              </div>
            </div>
          ...
          <div className="mt-8 text-center text-sm">
            ...
            <Link to="/login" className="font-semibold text-indigo-600 transition-colors hover:text-indigo-800">
              Login
            </Link>
          </div>
        </div>
